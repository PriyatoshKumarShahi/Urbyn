    ...
    <div className="grid gap-5 lg:grid-cols-[1.15fr_0.85fr]">
        ...
        <div className="brutal-card overflow-hidden bg-white">
          ...
          <div className="space-y-4 p-6">
            ...
            <div className="grid gap-2 text-sm text-slate-600">
              ...
              {issue.resolvedAt && <div><b>Resolved at:</b> {formatDate(issue.resolvedAt)}</div>}
            </div>
          </div>
        </div>
        ...
        {issue.resolvedImage && (
          <div className="grid gap-5 md:grid-cols-2">
            <div className="brutal-card bg-white p-4">
              <h3 className="text-2xl font-black">Before fix</h3>
              <img src={issue.image} alt="Before fix" className="mt-4 h-64 w-full rounded-[18px] border-[3px] border-ink object-cover" />
            </div>
            <div className="brutal-card bg-[#F7FFF7] p-4">
              <h3 className="text-2xl font-black">After fix</h3>
              <img src={issue.resolvedImage} alt="After fix" className="mt-4 h-64 w-full rounded-[18px] border-[3px] border-ink object-cover" />
            </div>
          </div>
        )}
      </div>
      <div className="space-y-5">
        <div className="brutal-card bg-[#F8FDFF] p-5">
          ...
          <div className="mt-4"><Timeline items={issue.statusHistory || []} deadline={issue.slaDeadline} /></div>
        </div>
      </div>
    </div>
  );
